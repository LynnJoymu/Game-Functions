...
game_input = input("A round of Rock, Paper, Scissors? yes or no: \n")
...
if game_input == "yes":
    ...
    print("Game well played, thank you!")
...
print("\nThat concludes the holiday coding Day 1. Please stay tuned for more days....\nIf there even is! Mwah-ha-ha-ha!")